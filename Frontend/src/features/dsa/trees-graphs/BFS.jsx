...
import { bfs as bfsCode } from "../../../core/constants/codeExamples.js";
            ...
            <Panel minSize={40} maxSize={70}>
              <div className="h-full flex flex-col p-4">
                ...
                <div className="flex-1 overflow-hidden rounded-2xl border-2 border-gray-200 bg-white shadow-lg">
                  <div
                    ref={cyRef}
                    className={`w-full h-full bg-transparent border-0 shadow-none ${theme === 'dark' ? 'bg-transparent' : 'bg-transparent'}`}
                  />
                </div>
              </div>
            </Panel>
