...
import { dfs as dfsCode } from "../../../core/constants/codeExamples.js";
            ...
            <div className="flex flex-col">
              ...
              <div className="mb-4 relative rounded-2xl border-2 border-gray-200 bg-white shadow-lg overflow-hidden">
                ...
                <button
                  ...
                  className="absolute bottom-4 right-4 p-3 rounded-full shadow-xl font-bold transition-all duration-300 bg-gradient-to-br from-cyan-500 to-blue-600 text-white hover:scale-110 cursor-pointer"
          ...
          >
            ...
            >
              ...
              <div className={`sticky top-0 z-10 p-4 border-b flex items-center justify-between ${theme === 'dark' ? 'bg-slate-900 border-white/10' : 'bg-white border-gray-200'
                ...
                <button
                  onClick={() => setIsMobileMenuOpen(false)}
                  className={`p-2 rounded-xl cursor-pointer ${theme === 'dark' ? 'hover:bg-white/10' : 'hover:bg-gray-100'}`}
                >
                      ...
                      <div className="grid grid-cols-2 gap-2">
                        {["undirected", "directed"].map(type => (
                          <button
                            ...
                            className={`py-3 px-4 rounded-xl font-bold transition-all duration-300 cursor-pointer ${graphType === type
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {['undirected', 'directed'].map(type => (
                      <button
                        ...
                        className={`py-2 px-3 rounded-lg font-bold text-xs transition-all duration-300 cursor-pointer ${graphType === type
