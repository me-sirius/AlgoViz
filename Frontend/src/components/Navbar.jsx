...
const Navbar = () => {
  ...
  const getTextColor = () => {
    ...
    if (isHomePage && !scrolled)
      return "text-white hover:text-white drop-shadow-md";
  ...
  const NavLink = ({ icon: Icon, text, onClick, active }) => (
    <button
      ...
      className={`group relative flex items-center space-x-2 px-4 py-2 rounded-xl transition-all duration-300 ${
        ...
        theme !== "dark" && isHomePage && !scrolled
    ...
    >
      <Icon
        ...
        } ${isHomePage && !scrolled && !active ? "drop-shadow-md" : ""}`}
      />
  ...
  return (
    <>
      ...
      >
          ...
          <div className="flex items-center justify-between h-20">
            ...
            >
              ...
              <div className="flex flex-col">
                <span
                  className={`text-2xl font-bold tracking-tight ${getLogoColor()}`}
                >
                  Algo
                  <span
              ...
              <div className="relative" ref={resourcesDropdownRef}>
                ...
                >
                  <BookOpen
                    size={18}
                    className={
                      isHomePage && !scrolled && !isResourcesDropdownOpen
                        ? "drop-shadow-md"
                        : ""
                    }
                  />
                ...
                {isResourcesDropdownOpen && (
                  <div
                    className={`absolute top-full left-0 mt-2 w-56 rounded-2xl p-2 shadow-2xl border backdrop-blur-xl transform transition-all duration-300 origin-top-left animate-in fade-in zoom-in-95 ${
                      theme === "dark"
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              >
                {theme === "dark" ? (
                  ...
                  <Moon
                    size={20}
                    className={isHomePage && !scrolled ? "drop-shadow-md" : ""}
                  />
                )}
              </button>
              ...
              {!isAuthenticated ? (
                <button
                  ...
                  className={`group relative px-6 py-2.5 rounded-xl font-bold text-sm transition-all duration-300 hover:shadow-lg hover:scale-105 active:scale-95 overflow-hidden ${
                    theme === "dark" || (isHomePage && !scrolled)
                ...
                <div className="relative" ref={userDropdownRef}>
                  <button
                    ...
                    className={`flex items-center space-x-3 pl-2 pr-4 py-1.5 rounded-full border transition-all duration-300 ${
                      theme === "dark"
                    ...
                    <div className="relative">
                      {user.avatar ? (
                        <img
                          src={user.avatar}
                          alt={user.name}
                          className="w-8 h-8 rounded-full object-cover ring-2 ring-offset-2 ring-cyan-500"
                        />
                      ) : (
                        <div
                  ...
                  {showUserDropdown && (
                    <div
                      className={`absolute right-0 mt-4 w-64 rounded-2xl p-2 shadow-2xl border backdrop-blur-xl transform transition-all duration-300 origin-top-right animate-in fade-in zoom-in-95 ${
                        theme === "dark"
                          ? "bg-slate-900/90 border-white/10 shadow-black/50"
                          : "bg-white/90 border-black/5 shadow-gray-200/50"
                      }`}
        ...
        {isMobileMenuOpen && (
          <div
            className={`md:hidden absolute top-full left-0 w-full h-[calc(100vh-5rem)] overflow-y-auto backdrop-blur-xl transition-all duration-300 ${
          ...
          >
            <div className="p-4 space-y-2">
              <div className="space-y-1">
                <button
                  onClick={() => handleNavigation("/")}
                  className={`w-full flex items-center space-x-3 px-4 py-4 rounded-xl font-medium ${
                    theme === "dark"
              ...
              <div className="space-y-1">
                <p
                  className={`px-4 text-xs font-bold uppercase tracking-wider mb-2 ${
              ...
              {!isAuthenticated ? (
                ...
                <div className="space-y-1">
                  ...
                  <button
                    onClick={handleLogout}
                    className="w-full flex items-center space-x-3 px-4 py-3 rounded-xl font-medium text-red-500 hover:bg-red-500/10"
                  >
                    <LogOut size={18} />
                    <span>Sign Out</span>
                  </button>
      ...
      {showAuthModal && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          />
          <div
            className={`relative w-full max-w-md transform overflow-hidden rounded-3xl p-8 text-left shadow-2xl transition-all animate-in fade-in zoom-in-95 ${
              theme === "dark"
          ...
          >
            ...
            <div className="space-y-4">
              <button
                onClick={() => handleAuthAction("/signin")}
                className={`w-full flex items-center justify-center space-x-3 p-4 rounded-xl font-bold transition-all duration-300 group ${
                  theme === "dark"
