...
const AlgorithmHomePage = () => {
  ...
  // Particle background: use canvas for better performanc

  // ... rest of your functions ...

  // 5. The Render Logic
  // If loading is true, ONLY show the LoadingPage.
  // If false, show the Blog content.
  // Topics data
  const topics = [
    {
      id: "arrays",
      ...
      description:
        "Explore fundamental array operations and sorting algorithms with interactive demonstrations",
      algorithms: [
        {
          name: "Bubble Sort",
          difficulty: "Easy",
    ...
    },
    {
      ...
      description:
        "Visualize complex tree structures and graph traversal algorithms in real-time",
      algorithms: [
        {
    ...
    },
    {
      ...
      description:
        "Master optimization problems with elegant dynamic programming solutions",
      algorithms: [
        {
    ...
    },
    {
      ...
      description:
        "Discover efficient searching techniques with visual complexity analysis",
      algorithms: [
        {
          name: "Linear Search",
          difficulty: "Easy",
    ...
    },
    {
      ...
      description:
        "Understand greedy strategies for solving optimization challenges",
      algorithms: [
        {
    ...
    },
    {
      ...
      description:
        "Solve complex constraint problems using intelligent backtracking",
      algorithms: [
        {
  ...
  return (
    <>
      ...
      >
        ...
        <header
          className={`relative overflow-hidden liquid-bg min-h-[90vh] flex items-center ${
            theme === "dark"
              ? ""
          ...
          <div className="absolute inset-0 overflow-hidden pointer-events-none">
            ...
            <div
              className={`absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full blur-3xl animate-pulse ${
                theme === "dark" ? "bg-blue-500/5" : "bg-white/10"
              }`}
            ></div>
          </div>
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="text-center lg:text-left space-y-8">
                  ...
                  >
                    <Sparkles
                      className={`w-4 h-4 animate-pulse ${
                        theme === "dark" ? "text-cyan-400" : "text-yellow-300"
                      }`}
                    />
                    <span
                    ...
                    <Star
                      className={`w-4 h-4 animate-pulse ${
                        theme === "dark" ? "text-yellow-400" : "text-yellow-200"
                      }`}
                    />
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    >
                      Transform complex algorithms into{" "}
                      <span
                        className={`font-bold ${
                          theme === "dark" ? "text-cyan-400" : "text-yellow-200"
                        }`}
                      >
                        interactive visualizations
                      </span>
                      . Learn through stunning animations and real-time
                      execution.
                    </p>
                  </div>
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <button
                      ...
                      className={`group relative px-8 py-4 font-bold text-lg rounded-2xl shadow-2xl transition-all duration-300 hover:scale-105 active:scale-95 overflow-hidden cursor-pointer ${
                        theme === "dark"
                    ...
                    <button
                      ...
                      className={`group px-8 py-4 rounded-2xl font-semibold text-lg transition-all duration-300 hover:scale-105 active:scale-95 border backdrop-blur-md cursor-pointer ${
                        theme === "dark"
                    ...
                    <div className="text-center lg:text-left">
                      ...
                      <div
                        className={`text-sm font-medium ${
                          theme === "dark" ? "text-slate-400" : "text-white/90"
                        }`}
                      >
                        Algorithms
                      </div>
                ...
                <div className="hidden lg:flex justify-center items-center">
                  <div className="relative w-full max-w-lg">
                    {/* Central Card */}
                    <div
                      className={`relative rounded-3xl p-8 shadow-2xl animate-float border-2 backdrop-blur-md ${
                        theme === "dark"
                          ? "glassmorphism border-cyan-500/30"
                    ...
                    >
                      <div className="space-y-6">
                        ...
                        <div className="flex items-end justify-between gap-2 h-32">
                          {[60, 80, 40, 100, 30, 70, 50, 90].map(
                            (height, i) => (
                              <div
                                key={i}
                                className={`flex-1 rounded-t-lg transition-all duration-300 hover:scale-110 ${
                                  theme === "dark"
                    ...
                    {/* Floating Icons */}
                    <div
                      className={`absolute -top-8 -left-8 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg animate-float ${
                        theme === "dark"
                    ...
                    <div
                      className={`absolute -bottom-8 -right-8 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg animate-float ${
                        theme === "dark"
                    ...
                    <div
                      className={`absolute top-1/2 -right-12 w-12 h-12 rounded-xl flex items-center justify-center shadow-lg animate-float ${
                        theme === "dark"
        ...
        <section ref={topicsRef} className="py-20 lg:py-32 relative">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div
              ...
              className="opacity-0 text-center mb-16 lg:mb-24"
            >
              ...
              >
                Master algorithms through interactive visualizations. Each
                category offers hands-on learning with real-time execution.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
              {topics.map((topic, index) => (
                <div
                  key={topic.id}
                  className={`group relative overflow-hidden rounded-3xl glassmorphism border transition-all duration-500 card-hover cursor-pointer ${
                    theme === "dark"
                  ...
                  onKeyDown={(e) => {
                    if (e.key === "Enter") openModal(topic);
                  }}
                >
                  {/* Gradient Background Overlay */}
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${
                      gradientClassMap[topic.id]
                      ...
                      >
                        ...
                        <div
                          className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${
                            gradientClassMap[topic.id]
                          } opacity-0 group-hover:opacity-50 blur-xl transition-opacity duration-500`}
                        ></div>
                      </div>
                      <div
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <div className="text-center mb-16 lg:mb-20">
                ...
                >
                  Experience algorithm education reimagined with cutting-edge
              ...
              <div className="grid md:grid-cols-3 gap-6 lg:gap-8">
                {/* Feature 1 */}
                <div
                  className={`group relative p-8 lg:p-10 rounded-3xl border overflow-hidden card-hover ${
                    theme === "dark"
                      ? "glassmorphism border-cyan-500/20 hover:border-cyan-400/40"
                      : "bg-white border-gray-200 hover:border-blue-400/50 shadow-lg"
                  }`}
                >
                  {/* Animated Border Top */}
                  ...
                  <div className="relative z-10 space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        Watch algorithms come alive with stunning real-time
                        animations, step-by-step execution, and interactive
                        controls.
                      </p>
                    </div>
                ...
                <div
                  className={`group relative p-8 lg:p-10 rounded-3xl border overflow-hidden card-hover ${
                    theme === "dark"
                      ...
                      : "bg-white border-gray-200 hover:border-emerald-400/50 shadow-lg"
                  }`}
                >
                  ...
                  <div className="relative z-10 space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        Deep dive into complexity analysis with live performance
                        metrics, comparison charts, and optimization insights.
                      </p>
                    </div>
                ...
                <div
                  className={`group relative p-8 lg:p-10 rounded-3xl border overflow-hidden card-hover ${
                    theme === "dark"
                      ? "glassmorphism border-purple-500/20 hover:border-purple-400/40"
                      : "bg-white border-gray-200 hover:border-purple-400/50 shadow-lg"
                  }`}
                >
                  ...
                  <div className="relative z-10 space-y-6">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        View implementations in Python, JavaScript, C++, Java,
                        and more with syntax highlighting and explanations.
                      </p>
                    </div>
        ...
        {isModalOpen && modalTopic && (
          <div
            className={`fixed inset-0 z-50 flex items-center justify-center p-4 backdrop-blur-xl ${
              theme === "dark" ? "bg-black/80" : "bg-gray-900/60"
            }`}
            onClick={closeModal}
            aria-modal="true"
            role="dialog"
          >
            <div
              className={`relative w-full max-w-6xl h-[90vh] flex flex-col rounded-3xl border overflow-hidden shadow-2xl ${
                theme === "dark"
                  ? "glassmorphism border-cyan-500/20"
            ...
            >
              {/* Header section */}
              <div
                className={`relative p-6 lg:p-8 bg-gradient-to-r ${
              ...
              >
                ...
                <div className="relative flex items-start justify-between gap-4">
                  <div className="flex items-start gap-4 flex-1">
                    <div
                      className={`p-4 rounded-2xl bg-white/10 backdrop-blur-sm shadow-xl`}
                    >
                      {modalTopic.icon}
                    </div>
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  {modalTopic.algorithms.map((algorithm, index) => (
                    <div
                      ...
                      className={`group relative p-6 rounded-2xl border transition-all duration-300 cursor-pointer ${
                        selectedAlgorithm?.id === algorithm.id
                          ? theme === "dark"
                            ? `bg-gradient-to-br ${
                                gradientClassMap[modalTopic.id]
                              }/20 border-cyan-400/50 shadow-xl scale-[1.02]`
                      ...
                      onKeyDown={(e) => {
                        if (e.key === "Enter") selectAlgorithm(algorithm);
                      }}
                    >
                      {/* Selection Indicator */}
                      {selectedAlgorithm?.id === algorithm.id && (
                      ...
                      <div className="space-y-3">
                        <h3
                          className={`text-xl font-bold transition-colors duration-300 pr-8 ${
                            selectedAlgorithm?.id === algorithm.id
                              ? theme === "dark"
                                ? "text-cyan-400"
                                : "text-blue-600"
                        ...
                        <div className="flex items-center gap-3">
                          <span
                            className={`text-xs px-3 py-1.5 rounded-full border font-semibold ${getDifficultyColor(
              ...
              {showComingSoon && (
                ...
                >
                  ...
                  >
                    <button
                      className={`absolute top-2 right-2 hover:text-red-400 transition-colors cursor-pointer ${
        ...
        {/* Footer - Redesigned */}
        <footer
          className={`relative border-t mt-32 py-20 overflow-hidden ${
            theme === "dark"
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
              ...
              <div className="lg:col-span-5 space-y-6">
                ...
                >
                  Master algorithms through stunning visualizations and
                  interactive learning. Transform your understanding of computer
                ...
                <div className="flex gap-3">
                  <a
                    href="#"
                    className={`p-3 rounded-xl border transition-all duration-300 hover:scale-110 hover:border-cyan-400/50 cursor-pointer ${
                      theme === "dark"
        ...
        {showScrollToTop && (
          <>
            ...
            <div className="fixed left-4 top-1/2 -translate-y-1/2 z-41">
              ...
              <div
                className={`absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-3 h-3 rounded-full transition-all duration-300 pointer-events-none ${
                  scrollHover
                    ? "opacity-0 scale-0"
