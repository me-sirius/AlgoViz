      ...
      <div className="min-h-screen bg-gradient-to-br from-[#0a0e17] via-[#0d1117] to-[#0a0e17] text-gray-100 font-sans">
        ...
        <nav className="sticky top-0 z-50 h-16 bg-gradient-to-r from-[#0a0e17]/90 to-[#0d1117]/90 backdrop-blur-xl border-b border-gray-800/30 px-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Structured DSA Mastery</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center font-bold text-sm shadow-lg shadow-blue-500/30">
              R
            </div>
          </div>
        </nav>
        ...
        <main className="max-w-6xl mx-auto px-6 py-8">
          ...
          <div className="mb-12 text-center">
            ...
            <p className="text-gray-400 max-w-2xl mx-auto text-lg">
              ...
              Track progress, visualize concepts, and practice with interactive
              challenges.
            </p>
          </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-800/50">
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <ProgressBar value={9} max={38} colorClass="bg-yellow-500" />
                </div>
            ...
            <div className="bg-gradient-to-br from-gray-900/80 to-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-800/50">
              <div className="flex items-center justify-between mb-8">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Your learning metrics</p>
                </div>
