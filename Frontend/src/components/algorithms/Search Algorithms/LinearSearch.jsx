...
const LinearSearch = () => {
  ...
  const [customArray, setCustomArray] = useState("64,34,25,12,22,11,90,88,76,50");
  ...
  const linearSearchAlgorithm = (array, target) => {
    const steps = [];
  ...
  const startSearch = () => {
    ...
    const searchSteps = linearSearchAlgorithm(currentArray, target);
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm">
              Time: O(n) | Space: O(1) | Sequential search through array
            </p>
          </div>
        </div>
      </div>
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-purple-400 font-mono">
                      {currentStepData.currentIndex >= 0 ? currentStepData.currentIndex : "N/A"}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className={`font-mono ${
                      ...
                      currentStepData.currentIndex >= 0 ? 'text-yellow-400' : 'text-gray-400'
                    }`}>
                      {currentStepData.found ? 'Found' : 
                       currentStepData.currentIndex >= 0 ? 'Searching' : 'Ready'}
                    </span>
                  </div>
                </div>
              </div>
          ...
          <div className="h-full bg-slate-900 flex flex-col items-center justify-center p-8">
            <div className="w-full max-w-4xl">
              ...
              <div className="text-center mb-8">
                <h2 className="text-xl font-semibold mb-2">Array Visualization</h2>
                    ...
                    <div
                      className={`
                        ...
                        ${index === currentStepData.currentIndex 
                          ? 'bg-yellow-500 text-black scale-110 ring-4 ring-yellow-300 ring-opacity-50' 
                          : index === currentStepData.foundIndex && currentStepData.found
                          ? 'bg-green-500 text-white scale-110 ring-4 ring-green-300 ring-opacity-50'
                          : value === target
          ...
          <div className="h-full bg-slate-800 border-l border-purple-500">
            ...
            <div className="p-6 h-full overflow-y-auto">
              {activeRightTab === "code" ? (
                ...
                <div className="space-y-6">
                  <div>
                    <h3 className="text-lg font-semibold mb-3">Linear Search</h3>
                    <p className="text-gray-300 text-sm leading-relaxed">
                      Linear search is the simplest searching algorithm that checks every element 
                      in the array sequentially until the target is found or the end is reached.
                    </p>
                  </div>
